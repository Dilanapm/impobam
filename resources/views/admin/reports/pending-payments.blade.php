...
<body>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8">No hay pagos pendientes para mostrar.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
